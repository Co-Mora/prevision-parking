...
export default {
  ...
  methods: {
    ...
    addStreetCarpark() {
        ...
        this.validated = true
        this.errors = []
        CarParkService.createData(`carpark/${this.carparkID}/zone/${this.carparkID}/street`, qs.stringify({
            name: this.name,
            image: this.image,
        }));
      }
    ...
    addStreetZone() {
        ...
        this.errors = []
        this.validated = true
         CarParkService.createData(`carpark/${this.carparkID}/zone/${this.zoneID}/street`, qs.stringify({
            name: this.name,
            image: this.image,
        }));
      }
