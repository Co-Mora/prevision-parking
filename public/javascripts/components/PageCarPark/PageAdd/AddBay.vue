                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-group" style="margin-bottom: 20px">
                                        <select v-model="zoneID" class="form-control m-b" @change="filterByStreet">
...
export default {
  ...
  methods: {
    ...
    addStreetCarpark() {
        ...
        this.errors = []
        this.validated = true
         CarParkService.createData(`carpark/${this.carparkID}/strret`, qs.stringify({
            name: this.name,
            image: this.image,
        }));
    ...
    addStreetBay() {
        ...
        this.errors = []
        this.validated = true
         CarParkService.createData(`carpark/${this.carparkID}/zone/${this.zoneID}/street/${this.streetID}/bay`, qs.stringify({
            name: this.name,
            image: this.image,
            lat: this.lat,
            lon: this.lon,
    ...
    filterByStreet() {
         CarParkService.fetchAllData(`carpark/${this.carparkID}/street`).then(response => {
