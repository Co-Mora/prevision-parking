<template>
    <div>
      ...
      <div class="modal inmodal fade" id="myModal5" tabindex="-1" role="dialog" aria-hidden="true">
                      ...
                      <div class="table-responsive">
                          <table class="table table-striped table-bordered table-hover dataTables-example">
                              ...
                              <tbody>
                                  ...
                                  <tr v-for="voucher in selectedVoucher" :key="voucher" class="gradeX">
         ...
         <div id="wrapper">
            <nav-side :classVoucher="classVoucher"/>
...
export default {
  ...
  methods: {
    getSearchResult() {
      if(this.searchResult.length === 0) {
        ...
        this.addVocuher()
          ...
          searchResult.findSearchResult(`carpark/${this.carparkID}/voucher?search=`, this.searchResult).then(response => {
    ...
    addVoucher() {
        ...
        CarParkService.viewData(`carpark/${this.carparkID}/voucher`).then(response => {
            this.voucher = response.data;
            this.messageVoucher = '';
            if (this.voucher.length === 0) {
    ...
    viewVoucher(value) {
        CarParkService.viewCarPark(`carpark/${this.carparkID}/voucher`, value).then(response => {
    ...
    deleteVoucher(value) {
        CarParkService.deleteData(`carpark/${this.carparkID}/voucher`, value)
    },
    ...
    updateVoucher(value) {
        ...
        this.validated = true;
        CarParkService.updateData(`carpark/${this.carparkID}/voucher`, value, qs.stringify({
            name: this.name,
            image: this.image,
