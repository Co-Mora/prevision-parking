      ...
      <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <ul class="nav nav-second-level collapse">
              <li :class="{ active: classOperator }">
                ...
                <ul class="nav nav-third-level">
                  <li :class="{ active: classOperator }">
                    <a href="/business/operators">Car Park Operator</a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <li :class="{ active: carparkActive }">
            ...
            <ul class="nav nav-second-level collapse">
              ...
              <li :class="{ active: classAll }">
                <a href="/carparks/zone">
                  Car Park Zone
                  <span class="fa arrow"></span>
                </a>
                <ul class="nav nav-third-level">
                  <li :class="{ active: classZone }">
                    <a href="/carparks/zone">Zone</a>
                  </li>
                  ...
                  <li :class="{ active: classStreet }">
                    <a href="/carparks/street">Street</a>
                  </li>
                  <li :class="{ active: classBay }">
                    <a href="/carparks/bay">Bay</a>
                  </li>
                </ul>
              </li>
          ...
          <li :class="{ active: location }">
            ...
            <ul class="nav nav-second-level collapse">
              <li :class="{ active: classCountry }">
                <a href="/location/countries">Country</a>
              </li>
              <li :class="{ active: classState }">
                <a href="/location/states">State</a>
              </li>
              <li :class="{ active: classCity }">
                <a href="/location/cities">City</a>
              </li>
            </ul>
          </li>
          ...
          <li :class="{ active: finance }">
            ...
            <ul class="nav nav-second-level collapse">
              <li :class="{ active: classGiro || classFinance }">
                <a href="#">
                  ParkBills
                  <span class="fa arrow"></span>
                </a>
...
export default {
  ...
  mounted() {
    ...
    if (this.classFinance || this.classGiro) {
      this.finance = true;
    }
