                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-9 m-b-xs">
                                <select v-model="seasonID" class="form-control m-b" @change="loadData">
                                    ...
                                    <option v-for="sea in season" :value="op.id" :key="sea">{{sea.name}}</option>
                                </select>
                              </div>
                              </div>
...
export default {
 name: 'SeasonFees',
  ...
  methods: {
    ...
    loadData() {
        CarParkService.fetchAllData(`operator/${this.operatorID}/season/${this.seasonID}/seasonFees`).then(response => {
