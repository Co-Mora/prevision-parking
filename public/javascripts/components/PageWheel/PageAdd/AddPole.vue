                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                                ...
                                <div class="form-group row"><label class="col-sm-2 col-form-label">Pole Name</label>
                                    <div class="col-sm-10"><input v-model="name"  placeholder="Name" type="text" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group row"><label class="col-sm-2 col-form-label">Pole Remark</label>
...
export default {
  ...
  methods: {
    ...
    addWheelMasterLock() {
        ...
        this.errors = []
        this.validated = true
        CarParkService.createData(`carpark/${this.carparkID}/wheelmasters/${this.wheelMasterID}/wheelpoles`, qs.stringify({
            name: this.name,
            remark: this.remark,
        }));
      }
